...
#STAR --runThreadN 5  --genomeDir ./reference-genome/ref2019/STAR --outFileNamePrefix ./results/totalRNA-sensitive1-ref2019 --outSAMtype BAM SortedByCoordinate --limitBAMsortRAM 6000000000 --outBAMsortingBinsN 200 --readFilesIn ./raw_data/totalRNA/sample1R1.fastq ./raw_data/totalRNA/sample1R2.fastq
